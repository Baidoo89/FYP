...
import { Building2, ClipboardCheck, Mail, ShieldCheck, UserRound } from 'lucide-react';
...
export default async function CommitteeProfilePage() {
  ...
  const initials = initialsFor(user.name) || 'CR';
        ...
        <div className="flex min-w-0 flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="min-w-0">
              <div className="pro-eyebrow">Committee Reviewer Profile</div>
              <h1 className="mt-2 break-words text-2xl font-semibold tracking-tight text-gray-950 sm:text-3xl">{user.name}</h1>
              <p className="mt-1 break-words text-sm text-gray-600">Official promotion committee recommendation account.</p>
            </div>
          </div>
          <Link href="/committee/review?segment=pending" className="inline-flex min-h-10 w-full items-center justify-center rounded-lg bg-brand-primary px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-brand-primaryDark sm:w-auto">
            Open Review Queue
          </Link>
        </div>
      </section>
        ...
        <div className="pro-card min-w-0 p-5 sm:p-6">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">Identity and authorization details used for committee recommendations, review history, and audit tracking.</p>
            </div>
          </div>
        ...
        <aside className="space-y-5">
          <section className="pro-card min-w-0 p-5">
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm leading-6 text-gray-600">Committee reviewers handle HR-verified files and record formal recommendations for final administrative action.</p>
              </div>
            </div>
          ...
          <section className="rounded-xl border border-emerald-200 bg-emerald-50 p-5 text-emerald-950 shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-bold">Secure Committee Access</p>
          ...
          <section className="rounded-xl border border-brand-primary/15 bg-brand-primarySoft p-5 text-brand-primary shadow-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 opacity-80">Review only verified files and record concise, defensible recommendation rationale.</p>
              </div>
            </div>
          </section>
        </aside>
